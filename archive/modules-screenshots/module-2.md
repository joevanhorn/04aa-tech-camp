<!-- READINESS: 12 markers. Surfaces: admin-console ×9 (2.3 STAGED list, 2.4 Owners, 2.5 Credentials, 2.6 OIDC app + User sign-on, 2.7 ACTIVE, 2.9 Managed connections, 2.11 access policy clients, 2.12 System Log) — all admin-login-only, headlessly capturable. lab-toolkit/VDI ×1 (2.9 "Set up my CRM resource" helper output). adapter-admin-UI ×2 (2.10 Agents DCR-selectable, 2.10 Resources) — need the paired MCP adapter admin console. -->
...
[SCREENSHOT: Directory > AI Agents list now showing TaskVantage Sales Agent with status STAGED]
...
[SCREENSHOT: The TaskVantage Sales Agent Owners tab showing your personal admin account listed as owner]
...
[SCREENSHOT: The TaskVantage Sales Agent Credentials tab showing the public key with status ACTIVE]
...
[SCREENSHOT: The newly created TaskVantage Agent UI OIDC web app page showing its Client ID and Client secret]
...
[SCREENSHOT: The TaskVantage Sales Agent User sign-on tab showing TaskVantage Agent UI linked]
...
[SCREENSHOT: The TaskVantage Sales Agent General tab showing status ACTIVE]
...
[SCREENSHOT: The Lab Toolkit "Set up my CRM resource" output printing each wiring step and finishing with OK: 'vantage-crm' wired]
...
[SCREENSHOT: The TaskVantage Sales Agent Managed connections tab showing the vantage-crm-as entry set to Only allow with the five granular crm.* scopes]
...
[SCREENSHOT: The adapter admin console Agents view showing TaskVantage Sales Agent imported with DCR-selectable turned on]
...
[SCREENSHOT: The adapter admin console Resources view showing the single vantage-crm-as resource, enabled, URL /crm/mcp, auth okta-cross-app, with the five crm.* scopes]
...
[SCREENSHOT: The vantage-crm-as access policy Assign to clients set to "The following clients" with TaskVantage Sales Agent added]
...
[SCREENSHOT: The System Log filtered on target.type eq "AIAgent" showing the agent lifecycle events — created, owner added, key added, key activated, app linked, agent activated, managed connection created]
