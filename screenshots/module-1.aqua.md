...
2. Paste this entire block and press **Enter**:
   ...
   Unblock-File $b
   & $b -OrgUrl "https://demo-aqua-hoverfly-22341.okta.com" `
        -BridgeAddress "10.0.0.5" `
        -OpenAIApiKey "<<OPENAI_API_KEY — VDI setup only>>" `
        -PersonaPassword "Tra!nme4321" `
        -InstallToolkit
   ```
...
─────────────────────────────
✓ Okta org reachable        (https://demo-aqua-hoverfly-22341.okta.com)
